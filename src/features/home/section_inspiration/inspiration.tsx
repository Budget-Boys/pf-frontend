  ...
  return (
    <section className={style.inspiration}>
      <div className={style.inspiration_container}>
        <div className={style.inspiration_module}>
          ...
          <div className={style.inspiration_text}>
            ...
            <p>
              Queremos que você se sinta no controle, com confiança para tomar
              as melhores decisões financeiras e alcançar a liberdade que tanto
              deseja.
            </p>
          </div>
